...
export const COLUMN_GUIDE = [
  ...
  },
  {
    ...
    kind: 'auto',
    note: '재고수량을 웹이 다시 계산하지 않고 usp_StockCalculation 결과를 사용합니다. 자동식과 검증 근거가 모두 없을 때만 INPUT_REQUIRED이며 최근원가·Product.Cost로 대체하지 않습니다.',
...
export const INPUT_GUIDE = [
  ...
  },
  {
    ...
    kind: 'manualSource',
    note: 'sourceRef·기준일·확정자·확정시각이 모두 있어야 하며 다른 주차로 자동 상속하지 않습니다. 2026년 22~28차만 원본 파일 SHA와 F셀 위치가 고정된 역사 증거를 마지막 보조수단으로 사용할 수 있습니다. 도착원가는 단순 업로드/자동매칭만으로 인정하지 않습니다.',
