...
export const COLUMN_GUIDE = [
  ...
  },
  {
    ...
    formula: '나라별 = 백상창고료((1차GW+2차GW) × 원/kg) + 관세1 + 관세2 + 선율 ÷ 1.1 + 월드운송료 ÷ 1.1 + 한국방역 ÷ 1.1. 콜롬비아 카네이션·장미·알스트로·루스커스는 세부차수 합계를 무게비율로 나누고, 과금중량이 총중량보다 크면 부피(CBM)비율로 나눕니다. 수국이 같은 APOLLO에 실리면 이 풀에 포함합니다.',
    kind: 'autoManual',
  ...
  },
  {
    ...
    formula: '같은 청구서 안의 꽃 품목 나라로 국가를 판정하고, 못 찾으면 농장명·인보이스 표기로 판정합니다. 콜롬비아는 인보이스의 “수국” 표기로 수국과 나머지 4품목을 나누되, 수국이 같은 APOLLO에 실리면 4품목 풀에 합쳐 무게비율(무게=과금무게일 때) 또는 CBM비율로 나눕니다.',
    kind: 'autoManual',
...
export const INPUT_GUIDE = [
  ...
  },
  {
    ...
    kind: 'autoManual',
    note: '카네이션·장미·알스트로·루스커스가 기본입니다. 수국이 같은 APOLLO에 실리면 통관·트럭·항공료 풀에 함께 넣습니다. 수국만 따로 온 AWB는 나라 단위로 계산합니다.',
