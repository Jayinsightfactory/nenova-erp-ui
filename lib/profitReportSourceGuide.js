...
export const COLUMN_GUIDE = [
  ...
  },
  {
    ...
    kind: 'auto',
    note: '재고수량을 웹이 다시 계산하지 않고 usp_StockCalculation 결과를 사용합니다. 자동식과 검증 근거가 모두 없을 때만 INPUT_REQUIRED입니다. Product.Cost는 현재 출고단가이므로 자동값으로 대체하지 않고, 비평균·비호주 품목에서만 사용자가 차수별 근거로 확인할 수 있는 추천값으로 표시합니다.',
