 ...
 *      명시한 WarehouseMaster.InputDate별 환율을 wd.TPrice로 가중평균한다. InputDate가 없으면
 *      다른 날짜로 대신하지 않고 해당 카테고리를 입력 필요 상태로 둔다.
 ...
 *
 * lib/kcsRateDateWeights.js#loadWarehouseDateWeights(WarehouseMaster.InputDate 단일 기준)로
