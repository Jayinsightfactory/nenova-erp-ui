...
export const TRANSLATIONS = {
  ko: {
    ...
    // 메뉴
    '주문등록':'주문등록','붙여넣기 주문등록':'붙여넣기 주문등록','업로드 주문등록':'업로드 주문등록','주문관리':'주문관리','발주관리':'발주관리',
  ...
  es: {
    ...
    // 메뉴
    '주문등록':'Reg. Pedido','붙여넣기 주문등록':'Reg. por Texto','업로드 주문등록':'Reg. por Archivo','주문관리':'Gest. Pedidos','발주관리':'Gest. Órdenes',
...
export function useLang() {
  // SSR과 브라우저의 최초 렌더는 항상 같은 값으로 시작한다. localStorage 언어를
  // 초기값으로 읽으면 서버(bi)와 브라우저(ko/es)의 문구가 달라 hydration이 깨진다.
  const [lang, setLangState] = useState('bi');
