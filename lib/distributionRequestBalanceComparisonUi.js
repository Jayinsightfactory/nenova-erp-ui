...
const PRODUCT_FACT_REASONS=new Set(['DATA_TRUNCATED','STOCK_SNAPSHOT_MISSING','DUPLICATE_STOCK_SNAPSHOT','INVALID_STOCK_SNAPSHOT','INVALID_DISTRIBUTION_TOTAL','AMBIGUOUS_DISTRIBUTION_UNIT','STOCK_MASTER_SCOPE_MISSING','INVALID_STOCK_MASTER_SCOPE','AMBIGUOUS_STOCK_MASTER_SCOPE']);
...
function reasonLabel(code) {
  ...
  return {PARSER_AMBIGUOUS:'원문 해석 확인 필요',REQUEST_SCOPE_MISMATCH:'요청 기간 확인 필요',REQUEST_IDENTITY_UNKNOWN:'고객·품목 확인 필요',REQUEST_QUANTITY_UNKNOWN:'요청 수량 확인 필요',UNIT_UNKNOWN:'단위 확인 필요',UNIT_CONVERSION_UNRESOLVED:'품목 단위 환산계수 미설정',AMBIGUOUS_DISTRIBUTION_UNIT:'분배 단위 확인 필요',AMBIGUOUS_STOCK_MASTER_SCOPE:'같은 차수 재고 원장 중복 확인',SOURCE_TIME_APPROXIMATE:'원문 시각 확인 필요',SOURCE_TIME_MISSING:'원문 시각 확인 필요',DATA_TRUNCATED:'조회 범위가 잘려 근거 확인 필요',MULTI_DATE_SHIPMENT:'여러 출고일 이력 확인 필요',DUPLICATE_REQUEST_ID:'중복 요청 식별값 확인 필요',MULTIPLE_SHIPMENT_EVENTS:'여러 출고 이력 확인 필요',NO_SHIPMENT_HISTORY:'분배 이력 미확인',COMPETING_SHIPMENT_EVENT:'다른 요청과 겹친 출고 이력 확인 필요',PARTIAL_SHIPMENT_HISTORY:'일부 분배 이력만 확인됨',SHIPMENT_DELTA_MISMATCH:'요청과 분배 변화량이 다름',STOCK_SNAPSHOT_MISSING:'전산 저장 잔량 미확인',DUPLICATE_STOCK_SNAPSHOT:'전산 저장 잔량이 여러 건입니다',INVALID_STOCK_SNAPSHOT:'전산 저장 잔량 확인 필요',INVALID_DISTRIBUTION_TOTAL:'전체 품목 분배 합계 확인 필요'}[key]||'근거 확인 필요';
}
