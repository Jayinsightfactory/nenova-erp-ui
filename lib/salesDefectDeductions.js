        ...
        await tQuery(
          `UPDATE WebSalesDefectDeduction
              SET OrderYear=@year, OrderWeek=@week, CustKey=@ck, CustName=@cn,
                ...
                OriginalQuantity=CASE WHEN IsCarryoverLedger=1 AND EstimateKey IS NULL THEN @qty ELSE OriginalQuantity END,
                RemainingQuantity=CASE WHEN IsCarryoverLedger=1 AND EstimateKey IS NULL THEN @qty ELSE RemainingQuantity END,
