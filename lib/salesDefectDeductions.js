...
export async function listDeductions({ year, week, manager = '', includeDeleted = false, history = false, includeCarryover = false } = {}) {
  await ensureSalesDefectTables();
  ...
  const scopeWhere = includeCarryover
