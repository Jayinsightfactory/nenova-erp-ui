         ...
         SELECT
                ...
                SUM(CASE WHEN ISNULL(sd.OutQuantity,0) <> 0
                           AND (
                             ...
                             OR ISNULL(sdt.BadDateCount,0) > 0
                           )
           ...
           OUTER APPLY (
             SELECT
                    ...
                    SUM(CASE WHEN ShipmentDtm IS NULL
                               OR sd.ShipmentDtm IS NULL
                               OR CONVERT(date, ShipmentDtm) <> CONVERT(date, sd.ShipmentDtm)
                             THEN 1 ELSE 0 END) AS BadDateCount
               FROM ShipmentDate
