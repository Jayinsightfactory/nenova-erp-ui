...
export function buildProfitReportXlsx({ major, rows, note, audit, visibleCols, confirmedTotals, monthly }) {
  ...
  if (Array.isArray(visibleCols) && visibleCols.length) buildFilteredSheet(wb, { major, rows, visibleCols, confirmedTotals });
