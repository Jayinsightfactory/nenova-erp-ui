...
export const PROFIT_REPORT_EXPLANATIONS = [
  ...
  { key: 'F', label: '기말상품재고액', source: '현재 대차수의 마지막 EXE ProductStock.Stock, 당주 매입·통관 원천 또는 검증 품목단가', formula: '원본 수식 카테고리 F = (G+H)÷매입수량×재고수량; 나머지는 품목별 시점단가×수량', confirmed: 'StockMaster.isFix 미사용; 최근원가·Product.Cost fallback 금지', manual: '최종값 직접입력 불가; 자동식 불가 품목만 단가 근거 등록' },
