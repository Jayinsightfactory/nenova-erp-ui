...
export function arrivalUploadViewScope(rows = [], fileName = '') {
  ...
  return selected ? { orderYear: String(selected.orderYear), orderWeek: normalizeArrivalWeek(selected.orderWeek), country: '', flower: '', product: '', farm: '', weekOrder: 'desc', allVarieties: true } : null;
}
