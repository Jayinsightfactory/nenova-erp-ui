...
// Legacy filter choices share display labels. Moving a choice must rank every raw
// member, not silently discard all but the last typed value with that label.
export function collectPivotOrderValues(rows, field, label) {
