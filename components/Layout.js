...
export const MENU_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/orders/sales-paste', labelKey: '영업부 붙여서 주문등록', popup: false },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/pre-shipment',           labelKey: '선출고 관리',    popup: false },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/raum/purchase-costs', labelKey: '라움 초이문 차수별 매입단가', popup: true },
