...
export default function MyCustomerOrders() {
  ...
  return <>
    ...
    <main className="my-order-page">
      ...
      <div ref={productAreaRef} className="grid-head"><span>품종 / 품목</span><span>현재 주문 · 입력수량 · 단위 · 입력 후</span></div>
