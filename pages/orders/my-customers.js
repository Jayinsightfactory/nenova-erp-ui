...
export default function MyCustomerOrders() {
  ...
  return <>
    ...
    <style jsx>{`
      ...
      .pinned-favorites{position:sticky;top:44px;z-index:4;display:flex;align-items:center;gap:4px;padding:4px 7px;background:#fffaeb;border:1px solid #fedf89;border-radius:8px;overflow-x:auto}.pinned-favorites>b{white-space:nowrap;color:#93370d}.pinned-favorites button{display:flex;align-items:center;gap:5px;white-space:nowrap;min-height:30px;font-weight:700}.pinned-favorites small{color:#b54708}.templates{margin:5px 0;padding:7px;background:#f9fafb;border:1px solid #d0d5dd;border-radius:9px}.templates-head{display:flex;justify-content:space-between;align-items:center}.templates-head div{display:flex;flex-direction:column}.template-columns{display:grid;grid-template-columns:1fr 1fr;gap:8px}.template-columns h3{margin:6px 0 3px;font-size:14px}.template-columns article{display:flex;gap:4px;margin-bottom:3px}.template-main{flex:1;display:flex;justify-content:space-between;align-items:center;text-align:left}.template-main.selected{border-color:#155eef;background:#eef4ff;box-shadow:0 0 0 2px #dbe7ff}.star{color:#b54708;font-weight:700}.delete-fav{color:#b42318}.template-preview{margin-top:7px;padding:7px;border:2px solid #84adff;border-radius:8px;background:white}.preview-title{display:flex;justify-content:space-between;align-items:center;gap:8px}.preview-title>div{display:flex;flex-direction:column}.load-template{background:#155eef;color:white;font-weight:800}.preview-items{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:2px 8px;margin-top:6px}.preview-items>div{display:grid;grid-template-columns:90px minmax(0,1fr) auto;gap:6px;padding:3px 5px;border-bottom:1px solid #eaecf0}.preview-items span{color:#667085;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.preview-items b{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.preview-items strong{color:#155eef;white-space:nowrap}@media(max-width:760px){.template-columns,.preview-items{grid-template-columns:1fr}.focus-bar{flex-wrap:wrap}.focus-bar span{width:100%}.pinned-favorites{top:76px}}
