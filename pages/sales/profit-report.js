...
function EditCell({ row, col, width = 86, edits, setEdit, autoValue }) {
  ...
  const F_SOURCE_TEXT = {
    ...
    verified_category_average: '원본 엑셀 공식: (매입액+그외통관비) ÷ 그 차수 매입수량 × 마지막 EXE ProductStock 수량',
    verified_carried_unit_cost: '이번 차수 매입이 없어 직전 차수 재고단가를 그대로 적용(첫 입고 시점 환율 유지)',
