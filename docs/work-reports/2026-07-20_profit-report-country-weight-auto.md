...
> 2026-08-12 정정: 아래의 과거 단일 등급표는 당시 구현 기록이며 현재 계산 규칙이 아니다. 현재는
> 1차+2차 무게를 합산한 뒤 `lib/colombiaTruck.js`의 차량 조합식(1.371t=2.5t 1대,
> 3t=2.5t+1t)을 사용하고, 저장된 실제 청구값이 있으면 그것을 우선한다.
