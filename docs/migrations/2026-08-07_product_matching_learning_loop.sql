...
BEGIN
  CREATE TABLE dbo.WebProductMatchEvent (
    ...
    QueryHash VARBINARY(32) NOT NULL, QueryPreview NVARCHAR(120) NOT NULL DEFAULT N'', Unit NVARCHAR(30) NOT NULL DEFAULT N'',
    EventType NVARCHAR(40) NOT NULL, CandidateProdKeysJson NVARCHAR(MAX) NOT NULL DEFAULT N'[]',
    SelectedProdKey INT NULL, ReplacedProdKey INT NULL, ConfirmedByUser BIT NOT NULL DEFAULT 0,
