...
assert.match(page, /\.paste-input-grid\.paste-baseline-collapsed \{ grid-template-columns: repeat\(4,/);
...
assert.match(page, /@media \(min-width: 1600px\) \{[\s\S]*?grid-template-columns: minmax\(0,1fr\) minmax\(0,2\.2fr\) minmax\(0,1fr\) minmax\(0,1fr\) minmax\(0,1fr\)/);
assert.match(page, /@media \(max-width: 768px\) \{[\s\S]*?\.paste-input-grid \{ grid-template-columns: 1fr; \}/);
assert.match(page, /\.paste-col-baseline \{ grid-column: 2; grid-row: 1 \/ span 2;/);
assert.match(page, /\.paste-column-order-input \{ grid-column: 3; grid-row: 1 \/ span 2;/);
