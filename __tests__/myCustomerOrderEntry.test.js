...
(async () => {
  ...
  assert.match(own,/req\.query\.view === 'previous-order'/); assert.match(own,/SELECT TOP 1 om\.OrderMasterKey/); assert.match(own,/ORDER BY om\.OrderWeek DESC, om\.OrderMasterKey DESC/); assert.match(own,/od\.OrderMasterKey=@masterKey/);
