...
(async () => {
  ...
  assert.doesNotMatch(page,/focusMode/); assert.doesNotMatch(page,/차수·업체 다시 선택/); assert.match(page,/selectedCustomer/);
  ...
  assert.match(page,/entry-layout/); assert.match(page,/grid-template-columns:minmax\(0,1fr\) 360px/); assert.match(page,/max-width:1920px/); assert.match(page,/왼쪽에서 수량을 입력하면 바로 이곳에 표시됩니다/);
  ...
  assert.match(page,/alphabet-bar/); assert.match(page,/product-scroll/); assert.match(page,/max-height:calc\(100vh - 350px\)/);
  assert.match(page,/position:sticky;top:0;z-index:6/); assert.match(page,/\.product-scroll\{max-height:calc\(100vh - 350px\)/);
