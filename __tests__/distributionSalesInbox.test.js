...
assert.match(automaticLiveHistoryRead,/messages\.slice\(0,LIVE_HISTORY_MESSAGE_LIMIT\)\.map/);assert.match(automaticLiveHistoryRead,/liveHistoryScopeEpoch/);assert.match(automaticLiveHistoryRead,/liveHistoryBatchKeyRef/);assert.match(automaticLiveHistoryRead,/12000/);
